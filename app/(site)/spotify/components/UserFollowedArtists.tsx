...
interface UserFollowedArtistsProps {
  artists: Artist[];
}

const UserFollowedArtists: React.FC<UserFollowedArtistsProps> = ({
  artists,
}) => {
    ...
    <div className="flex flex-col pb-8">
      <div className="p-6 w-full flex justify-between">
        <div className="flex flex-col">
          <h1 className="text-white text-4xl font-bold">Followed Artists</h1>
          <p className="text-neutral-400 text-lg pt-3 truncate">
            A few of your followed artists
          </p>
        </div>
